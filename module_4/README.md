В этом проекте удалось:
* Применить все базовые операторы SQL.
* Поработать с базой данных, соединением и объединением таблиц.
Дана база данных различных авиарейсов. Задача: ответить на заданные в текстовом файле вопросы и предоставить таблицу, содержащую все авиарейсы из города Анапа и необходимые столбцы.
<br>
